...
names = text(characters(whitelist_characters=list("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_æøåÆØÅ"), whitelist_categories=()), min_size=5, max_size=20)
