...
def genOutSideFunction(draw, variables, functions, globalfunctions, properties):
    functioncode, functionname, funtiontype, variablesFromFunction, parameterlisttype, inlinefunction, globalfunctions = draw(
